 ...
 */
export const reduxAssist = (reducer_name, state_initial, store) => {
    ...
    keys.forEach((key) => {
        ...
        const ACTION = `@app/@${reducer_name}/${key}`; // action type
...
export class StoreModule {
    ...
    reduxAssist = (reducer_name, state_initial) => {
        const {state, reducer} = reduxAssist(reducer_name, state_initial, this.store);
