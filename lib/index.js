(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', './redux-assist', './Jss', 'react-jss', '@iosio/components/lib/asyncComponent'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('./redux-assist'), require('./Jss'), require('react-jss'), require('@iosio/components/lib/asyncComponent'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.reduxAssist, global.Jss, global.reactJss, global.asyncComponent);
        global.index = mod.exports;
    }
})(this, function (exports, _react, _reduxAssist, _Jss, _reactJss, _asyncComponent) {
    'use strict';
    ...
    var CapsuleProvider = exports.CapsuleProvider = function CapsuleProvider(_ref2) {
        var provide_to_logic = _ref2.provide_to_logic,
            ...
            _ref2$loading_options = _ref2.loading_options,
            loading_options = _ref2$loading_options === undefined ? { duration: undefined, fadeSwitch_props: {}, fader_props: {} } : _ref2$loading_options;
        var duration = loading_options.duration,
            fadeSwitch_props = loading_options.fadeSwitch_props,
            fader_props = loading_options.fader_props;


        var AppComponent = (0, _asyncComponent.asyncComponent)(loadApp, loadingComponent, duration, fadeSwitch_props, fader_props);
                ...
                value: function render() {
                    ...
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _Jss.Jss,
                            Object.assign({}, props, { theme: theme, global_styles: global_styles, __source: {
                                    fileName: _jsxFileName,
                                    lineNumber: 42
                                },
                                __self: this
    ...
    var Capsule = exports.Capsule = function Capsule(_ref3) {
        ...
        var return_logic = logic && logic(Object.assign({
            state: state,
            store: store
        }, _provide_to_logic, {
