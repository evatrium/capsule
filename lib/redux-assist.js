(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'redux-dynamic-reducer', 'redux', 'react-redux', 'react'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('redux-dynamic-reducer'), require('redux'), require('react-redux'), require('react'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.reduxDynamicReducer, global.redux, global.reactRedux, global.react);
        global.reduxAssist = mod.exports;
    }
})(this, function (exports, _reduxDynamicReducer, _redux, _reactRedux, _react) {
    'use strict';
    ...
    var _class,
        _temp,
        _initialiseProps,
        _jsxFileName = 'src/redux-assist.js';
     ...
     */
    var StoreModule = exports.StoreModule = (_temp = _class =
    /**
     * @constructor
    ...
    function StoreModule() {
        ...
        this.state = {};
        this.connect = _reactRedux.connect;
        this.Provider = function (props) {
            return _react2.default.createElement(
                _reactRedux.Provider,
                { store: _this.store, __source: {
    ...
    , _initialiseProps = function _initialiseProps() {
        ...
        this.reduxAssist = function (reducer_name, initial_state) {
            _this2.state = addStateControllers(reducer_name, initial_state, _this2.store, _this2.state);
            var handlers = createHandlers(reducer_name, initial_state);
            var reducer = createReducer(initial_state, handlers);
            _this2.store.attachReducers(_defineProperty({}, reducer_name, reducer));
            return _this2.state;
        };
    }, _temp);
});